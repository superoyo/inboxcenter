...
function mapPost(p) {
  return {
    ...
    reactionCount: (p.reactions && p.reactions.summary && p.reactions.summary.total_count) || 0,
    shareCount: (p.shares && p.shares.count) || 0,
  };
}
...
module.exports = {
  ...
  getPosts, getPostsSince, getComments, replyComment,
};
