...
- Analytics: ตัวเลข "ความเร็วในการตอบ" ทุกตัว (เวลาตอบเฉลี่ย · SLA 1 ชม./12 ชม./10 นาที ·
  เวลาที่ห้องค้าง) นับเฉพาะ **เวลาทำการ 09:00–18:00** ตามเวลาผู้ดู ไม่ใช่นาฬิกา 24 ชม.
  ของวันจันทร์–ศุกร์ (เสาร์–อาทิตย์ = นอกเวลาทั้งวัน) ตั้งค่าที่ [lib/business-hours.js](lib/business-hours.js) ที่เดียว
  · `/api/analytics` ส่ง `workHours` กลับไปให้หน้าเว็บแสดงว่าวัดจากอะไร
